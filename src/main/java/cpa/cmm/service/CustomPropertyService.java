...
public class CustomPropertyService 
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(CustomPropertyService.class);
	...
	public void reloadPropertiesForDB() throws Exception{
		...
		try {
			...
			if (properties != null) {
				...
				while (it.hasNext()) {
					...
					LOGGER.debug(messageSource.getMessage("debug.properties.property", new String[] { key, value.toString() }, Locale.getDefault()));
	...
	public List<String> getStringArrayList(String name) {
		List<String> list = new ArrayList<String>();
		String[] array = getConfiguration().getStringArray(name);
		if(array != null){
