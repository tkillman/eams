...
public class StdntRegistTableVO extends CmmnVO implements Serializable {
	...
	private List<StdntFrndVO> stdntFrndList;
	private List<StdntAcdmcrVO> stdntAcdmcrList;
	private List<StdntCareerVO> stdntCareerList;
	private List<StdntFamilyVO> stdntFamilyList;
	private List<StdntQualfLcnsVO> stdntQualfLcnsList;
